  ...
  cards.forEach(function(card) {
    card.addEventListener('click', function() {
      ...
      if (selectedCards.length < 2) {
        ...
        // Fix: 1 - Pushing the selected card to the "selectedcards[]" to make further comparison actions
      ...
      if (selectedCards.length === 2) {
        ...
        //Fix: 2 - Changed the Card array sequence to match the first selected card with the second one
      ...
      // If we've matched all the cards, display a message.
       ...
       //Fix:4 - matchedcards length has been changed to the actual length of the cards in the array
